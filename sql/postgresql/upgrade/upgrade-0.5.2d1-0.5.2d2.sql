...
-- old define_function_args('bulk_mail__new','new__bulk_mail_id;to null,new__package_id,new__send_date;to null,new__date_format;to "YYYY MM DD HH24 MI SS",new__status;to "pending",new__from_addr,new__subject;to null,new__reply_to;to null,new__extra_headers;to null,new__message,new__query,new__creation_date;to now(),new__creation_user;to null,new__creation_ip;to null,new__context_id;to null')
-- new
